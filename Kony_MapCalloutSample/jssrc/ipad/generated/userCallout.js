//Template File
function userCallout_hbox1591284994232834_onClick_seq0(eventobject) {
    customOnClickEvent.call(this);
};

function userCallout_vbox1590152936135729_onClick_seq0(eventobject) {
    frmMap.map1590152936135706.dismissCallout(frmMap.map1590152936135706.locationData);
};
...
function initializeuserCallout() {
    ...
    hbox1591284994232834 = new kony.ui.Box({
        "id": "hbox1591284994232834",
        "isVisible": true,
        "skin": "hbxSkin",
        "onClick": userCallout_hbox1591284994232834_onClick_seq0,
        "orientation": constants.BOX_LAYOUT_HORIZONTAL
    }, {
        "containerWeight": 25,
        "percent": true,
