function locationData() {
    ...
    frmMap.map1590152936135706.locationData = lData;
}

function customLocationData() {
    frmMap.map1590152936135706.calloutTemplate = hbox1590152936135720;
    frmMap.map1590152936135706.calloutWidth = 80;
    frmMap.map1590152936135706.widgetDataMapForCallout = {
        lbl1: "data1",
        lbl2: "data2",
        img1: "img1",
        img2: "img2"
    ...
    frmMap.map1590152936135706.locationData = clData;
}
...
function customLocationData5() {
    frmMap.map153216384494396.calloutTemplate = hbox153216384497098;
    frmMap.map153216384494396.calloutWidth = 80;
    frmMap.map153216384494396.widgetDataMapForCallout = {
        lbl1: "data1",
        lbl2: "data2",
        img1: "img1",
        img2: "img2"
    ...
    frmMap.map153216384494396.locationData = clData;
}

function SegmentOnclick() {
    frmMap.map153216384494396.widgetDataMapForCallout = {
        lbl1: "data1",
        lbl2: "data2",
        img1: "img1",
    ...
    frmMap.map153216384494396.navigateToLocation(locationData, true, true);
}

function customLocationData3() {
    frmiPadMap.map1591284994232833.calloutTemplate = hbox1591284994232834;
    frmiPadMap.map1591284994232833.calloutWidth = 80;
    frmiPadMap.map1591284994232833.widgetDataMapForCallout = {
        lbl1: "data1",
        lbl2: "data2",
        img1: "img1",
        img2: "img2"
    ...
    frmiPadMap.map1591284994232833.locationData = clData;
}
